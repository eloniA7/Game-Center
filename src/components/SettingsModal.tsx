        ...
        return (
          <div className="space-y-2 animate-in fade-in slide-in-from-right-4 duration-300">
            ...
            <div className="space-y-2">
               <button className="w-full flex items-center gap-3 p-4 bg-white/[0.03] rounded-2xl border border-white/5 hover:bg-white/[0.08] transition-all">
                  <div className="w-8 h-8 bg-[#4285F4]/10 rounded-lg flex items-center justify-center font-bold text-[#4285F4]">G</div>
                  <span className="font-bold text-sm">Google</span>
                  <span className="ml-auto text-[10px] uppercase font-black text-green-500 tracking-tighter">Connected</span>
               </button>
